...
# def adjust_learning_rate(optimizer, epoch,  lr_decay=0.1):
#
#     # --- Decay learning rate --- #
#     # step =  2
#
...
def adjust_learning_rate(optimizer, epoch,  lr_decay=0.1):
    ...
    if epoch > 2 and epoch < 4:  # if epoch >3 and epoch<11:
        for param_group in optimizer.param_groups:
            param_group['lr'] *= 0.5#lr_decay
            print('Learning rate sets to {}.'.format(param_group['lr']))

    # if epoch > 19 and epoch<21:
    #     for param_group in optimizer.param_groups:
    #        param_group['lr'] *= 0.1#lr_decay*0.1
    #        print('Learning rate sets to {}.'.format(param_group['lr']))
    else:
        for param_group in optimizer.param_groups:
            print('Learning rate sets to {}.'.format(param_group['lr']))